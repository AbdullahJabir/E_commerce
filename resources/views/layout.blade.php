                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel panel-default">
                            ...
                            $category=DB::table('tbl_category')
                               ...
                               <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/productby_category/'.$row->category_id)}}">{{$row->category_name}}</a></h4>
                                </div>
                            </div>
                            <?php }?>
                        ...
                        <div class="brands_products"><!--brands_products-->
                           ...
                           <div class="brands-name">
                            ...
                            $category=DB::table('tbl_manufacture')
                                    ...
                                    ->get();
                                      foreach($category as $row){?>
                                <li><a href="{{URL::to('/productby_manufacture/'.$row->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$row->manufacture_name}}</a></li>
                                    <?php }?> 
                                </ul>
                            </div>
                        </div><!--/brands_products-->
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="{{asset('frontEnd/imagesimages/home/shipping.jpg')}}" alt="" />
                        </div><!--/shipping-->
