...
@include('slider')
                       ...
                       <?php foreach($all_published_product as $row){?>
                        <div class="col-sm-4">
                                ...
                                <div class="single-products">
                                        ...
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2>{{$row->product_price}} Tk</h2>
                                                <p>{{$row->product_name}}</p>
                                                <a href="{{URL::to('/view_product/'.$row->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                                        </div>
                                </div>
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <li><a href="{{URL::to('/view_product/'.$row->product_id)}}"><i class="fa fa-plus-square"></i>View Product</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
